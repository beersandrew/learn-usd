...
if __name__ == "__main__":
    ...
    for x in range(count):
        file_contents = file_contents + build_item("sphere_" + "{id}".format(id=x), "base_sphere", "world", random.uniform(minX, maxX), random.uniform(minY, maxY), random.uniform(minZ, maxZ), random.uniform(minRadius, maxRadius), random.random(), random.random(), random.random())
    print(file_contents)
